...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = (noteDict != nil) ? @"Edit note" : @"Add note";
    ...
    self.noteDetail.accessibilityIdentifier = @"Note Text";
    self.navigationItem.leftBarButtonItem.accessibilityLabel = @"Cancel";
    self.navigationItem.rightBarButtonItem.accessibilityLabel = @"Save";
...
- (void)popupActionSheet
{
   ...
   destructiveButtonTitle:nil otherButtonTitles:@"Mail Note", @"Instapaper", nil];
